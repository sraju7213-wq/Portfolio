...
export default function CaseStudyModal({ study, onClose }: CaseStudyModalProps) {
  ...
  // Lenis must be stopped while the modal is open so its global wheel
  // interception doesn't eat the scroll events that should reach the
  // modal's own overflow-y-auto container.
  useEffect(() => {
