...
export default function PersonalProjects() {
  return (
    <section id="personal" className="py-24 lg:py-32 relative overflow-hidden">
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] rounded-full bg-accent-cyan/[0.04] blur-[150px]" />
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] rounded-full bg-accent-violet/[0.04] blur-[150px]" />
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {personalProjects.map((project, i) => (
            ...
            >
              ...
              <div className="relative bg-bg-card rounded-3xl p-8 lg:p-10 border border-border-subtle card-hover overflow-hidden">
                ...
                <div className="relative">
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <div
                      className="w-10 h-10 rounded-xl flex items-center justify-center border border-border-subtle group-hover:border-transparent transition-all duration-300 group-hover:translate-x-1 group-hover:-translate-y-1"
