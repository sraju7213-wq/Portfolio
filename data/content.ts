...
export const experience = [
  ...
  },
  {
    ...
    role: "Graphic Designer & Data Entry Specialist",
...
export const portfolioProjects = [
  ...
  {
    title: "E-Commerce Product Listing Suite",
    category: "E-Commerce",
  ...
  {
    title: "Premium Brand Banner Collection",
    category: "Banners",
  ...
  {
    title: "Product Catalog — Annual Edition",
    category: "Catalogs",
    description: "Designed a 48-page product catalog with detailed specifications, lifestyle imagery, and clean editorial layouts.",
  ...
  {
    title: "Instagram Reel Series — Product Showcase",
    category: "Social Media",
    description: "Produced engaging short-form video content showcasing product features with dynamic transitions and branded overlays.",
  ...
  {
    title: "Houseboat Holidays — Digital Presence",
    category: "Web Dev",
